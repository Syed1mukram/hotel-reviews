...
class TimelineBuilder:
    ...
    # =========================================================
        ...
        # First visual must be original hotel image.
        if is_first:
        ...
        # Prefer unused original hotel image.
        ...
        # Final relevant stock-image attempt.
        result = self.find_stock_image(
            query=prompt
        )
        if result:
        ...
        # Prevent previous visual from getting held for this segment.
        fallback_queries = [
        ...
        for fallback in fallback_queries:
            ...
            if result:
                print(
                    f"[FALLBACK IMAGE] {fallback}"
                )
                return result

        print(
            "[WARNING] No visual available for sentence."
        )
        return None
